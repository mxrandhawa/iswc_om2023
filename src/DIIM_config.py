...
#RES_DIR = PROJECT_DIR + "/res/data/IoT4Win_demo" #for IoT4Win project
RES_DIR = PROJECT_DIR + "/res/data/ISWC_workshop_2023"

# S3O path
DIIM_S3O_LOAD_PATH = PROJECT_DIR +'/s3o'

DIIM_INPUT_DIR = RES_DIR + "/input" #  for iot data and ontologies
